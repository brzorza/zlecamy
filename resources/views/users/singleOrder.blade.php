            ...
            <div class="w-100 min-h-96 rounded-2xl flex flex-row gap-10 items-center px-20 pt-10 pb-14 my-10 bg-backgroundl">
                <div>
                    ...
                    <div class="flex flex-row gap-10">
                        ...
                        <div class="flex flex-row gap-10">
                            <a href="{{ route('profile.chat', ['id' => $order->chat_id]) }}" class="border border-primary py-4 px-16 rounded-xl text-lg font-semibold hover:bg-primary hover:text-background cursor-pointer">Pokaż chat</a>
                            <div>
